...
=======================================================================================*/
#ifndef __FileDeal_H__
#define __FileDeal_H__
...
的字符化常数定义：
----------------------------------------------------------------------------------------*/
#define cFileNum             60*24       // 60*24*64=92160/1024=90K
#define cFileNameLen         64          // 长度
...
typedef struct 
{
  char  Data[cFileNameLen];
}FileNameStru;

typedef struct 
{
  int  FileNum;
  FileNameStru Name[cFileNum];
}FileDealStru;
