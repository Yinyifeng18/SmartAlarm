...
=======================================================================================*/
#ifndef __DiskDeal_H__
#define __DiskDeal_H__
...
---------------------------------------------------------------------------------------*/
#define cUeventBufferSize  2048
#define cBufferSize   32
#define cDefaultDiskPath "/mnt/mmc/"

#define cMinFreeSpace    128*1024*1024
...
typedef struct 
{
  ...
  char    Total[cBufferSize];
  char    Avail[cBufferSize];
  char    Free[cBufferSize];
}DiskDealStru;
...
的全局变量声明：
---------------------------------------------------------------------------------------*/
extern DiskDealBits gbitDisk;
extern DiskDealStru gstvDisk;
